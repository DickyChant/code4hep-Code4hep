...
def scan_directory(
    ...
    for bf in buildfiles:
        ...
        if _has_cmake_child(bf.parent):
            statements.append("")
            statements.append(
                "# Descend into child package directories (one add_subdirectory each)."
            )
    ...
    _STRUCTURAL_CONTENT = (
        ...
        "# package subdirectories. c4h_auto_subdirectories() runs an\n"
        "# add_subdirectory() for each child directory with a CMakeLists.txt.\n"
